...
import type ConfirmPasswordStruct from './confirm_password_struct'
import type UpdateAttributesStruct from './update_attributes_struct'
...
export type {
  ...
  ResetPasswordStruct,
  ConfirmPasswordStruct,
  UpdateAttributesStruct
}
